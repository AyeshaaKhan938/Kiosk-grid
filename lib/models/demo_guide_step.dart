  ...
  static List<DemoGuideStep> allSteps({required bool isCoilMachine}) {
    ...
    return [
      ...
      const DemoGuideStep(
        ...
        destination: DemoGuideDestination.adminSettings,
        bullets: [
          'Admin Settings → CLOUD BACKEND: confirm API URL and Machine No.',
          'Set Management Token (from vms-cloud) to unlock the Admin Panel tabs.',
          'Tap Activate cloud device — a device token enables heartbeat and fault upload.',
